...
public class mybatisplus {
    ...
    GlobalConfig gc = new GlobalConfig();
        gc.setAuthor("model");
        gc.setOutputDir("D://项目/xiaoyuan/xiaoyuan-model/src/main/java/com.xiaoyuan");
    ...
    //});
        ...
        dsc.setUsername("xiaoyuan123");
        dsc.setPassword("xiaoyuan");
        dsc.setUrl("jjdbc:mysql://rm-wz942s30t361ycw1ufo.mysql.rds.aliyuncs.com:3306/xiaoyuan?useUnicode=true&useSSL=false&characterEncoding=utf8");

    // 策略配置
    StrategyConfig strategy = new StrategyConfig();
    // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setTablePrefix(new String[] { "tl_school" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "ustl_school_attenceer" });
        ...
        strategy.setInclude(new String[] { "utl_school_order" });
    ...
    PackageConfig pc = new PackageConfig();
        pc.setParent("com.xiaoyuan.generator");
